				...
				<table class="table_lm" style="width: 98%;">
					<tbody>
						...
						<tr>
							...
							<td class="Ggysum_big odds" id="o_gysum_big">39.00</td>
							...
							<td class="Ggysum_small odds" id="o_gysum_small">39.00</td>
							...
							<td class="Ggysum_dan odds" id="o_gysum_dan">18.00</td>
						...
						<tr>
							...
							<td class="Ggysum_small odds" id="o_gysum_small">18.00</td>
							<td class="Ggysum_small amount ha"><input name="gysum_small" class="ba"></td>
							...
							<td class="Ggysum_shuang odds" id="o_gysum_shuang">39.00</td>
							<td class="Ggysum_shuang amount ha"><input name="gysum_shuang" class="ba"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="Ggysum_shuang odds" id="o_gysum_shuang">1.75</td>
							<td class="Ggysum_shuang amount ha"><input name="gysum_shuang" class="ba"></td>
						</tr>
					</tbody>
				</table>
