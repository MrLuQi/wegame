				...
				<div class="control n_anniu">
					<div class="buttons">
						<label class="checkdefault"><input type="checkbox"
							...
							<input></label> <input type="button" onclick="submitdata()"
				...
				<table class="table_lm" style="width: 98%;">
					<tbody>
						...
						<tr>
							...
							<td class="Ggysum_big amount ha"><input name="WEI1"
								class="ba" id="WEI1"></td>

							<th class="Ggysum_small name" title="2点"><input
								type="hidden" id="" value="2">2点</th>
							<td class="Ggysum_small odds" id="rate10">185.00</td>
							<td class="Ggysum_small amount ha"><input name="WEI2"
								class="ba" id="WEI2"></td>

							<th class="Ggysum_dan name" title="3点"><input type="hidden"
								id="" value="3">3点</th>
							<td class="Ggysum_dan odds" id="rate11">185.00</td>
							<td class="Ggysum_dan amount ha"><input name="WEI3"
								class="ba" id="WEI3"></td>
					...
					<tbody>
						<tr>
							...
							<td class="Ggysum_big amount ha"><input name="QUAN"
								class="ba" id="QUAN"></td>
				...
				<table class="table_lm" style="width: 98%;">
					<tbody>
						...
						<tr>
							...
							<td class="Ggysum_shuang amount ha"><input name="seven"
								class="ba" id="seven"></td>
						</tr>
					</tbody>
					<tbody>
						<tr>
					...
					<tbody>
						<tr>
							...
							<td class="Ggysum_big amount ha"><input name="sixteen"
								class="ba" id="sixteen"></td>

							<th class="Ggysum_small name" title="17点"><input
								type="hidden" id="" value="17">17点</th>
							<td class="Ggysum_small odds" id="rate29">54.50</td>
							<td class="Ggysum_small amount ha"><input name="seventeen"
								class="ba" id="seventeen"></td>
