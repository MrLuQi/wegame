...
<html>
    ...
    margin-right: 10%;">编号：155813</span><span>余额：</span><span style="color: #006DCC;">0.00</span>
			...
			<div class="top-right">
				<ul>
					<li>
						<a href="${ctx}/chongzhi" target="chong">充值</a>
					</li>
					<li>
						<a href="${ctx}/tixian" target="chong" class="active">提款</a>
					</li>
					<li>
						<a>交易历史</a>
					</li>
		...
		<div class="iframes">
			<iframe id="chong" name="chong" src="${ctx}/tixian" marginheight="0" marginwidth="0" frameborder="0" scrolling="no" style="position: relative;left: 10px;top: 10px;width: 99%;height: 700px;"></iframe>
	</body>
