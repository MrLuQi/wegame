...
<link rel="stylesheet" href="css/Jiangsu.css" />
		...
		function getTime() {
			...
			function submitdata(){
				JSTB.action = "${ctx}/sscFOURdata?times=" + times+"&Periodno="+Periodno;
				//投注金额
				var valList = [];
				//投注金额总数
				 var sum = 0;
...
<!-- content-->
	<body class="l_pk10 P_lm skin_red">
		...
		<div id="main">
		<form id="JSTB" action="${pageContext.request.contextPath }/sscFOURdata" method="post">
			<div id="header">
				<!--开奖-->
				<div class="lottery_info">
					<div class="lottery_info_left floatleft"><span class="name" id="lotteryName">重庆时时彩</span> — <span class="gameName" id="gameName">第四球</span><span class="result">&nbsp;今日输赢：<span id="bresult">0</span></span>
					</div>
